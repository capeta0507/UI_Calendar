...
function showCalendar(currYear,currMonth){
  ...
  if((firstDayIdx == 6 && lastDayIdx != 6) || (firstDayIdx !=0 && lastDayIdx == 0) ){
    if(current_lastDay > 29){
      fillingCol = 0;
    }

  }

  for(var z = (fillingCol + 6 - lastDayIdx);z>0;z--){
    // console.log(z)
